...
function getItemTypeLabel(item: CartItem) {
  return item.type === "naming-package" ? "naming-package" : item.type;
}
...
export default function CartPage() {
  ...
  const rawLang = typeof params?.lang === "string" ? params.lang : "ko";
        ...
        {!mounted ? (
          ...
          <>
              ...
              <div className="wink-form" style={{ gap: 14 }}>
                {items.map((item) => (
                  <article key={item.id} className="wink-mini-card">
                    <div className="wink-result-head" style={{ marginBottom: 10 }}>
                      <div>
                        {item.selectedName && (
                          <div
                        ...
                        <div
                          className="wink-card-title"
                          style={{
                            fontSize: item.selectedName ? 16 : 24,
                            marginBottom: 6,
                            opacity: item.selectedName ? 0.7 : 1,
                          }}
                        >
                          {item.title}
                        </div>
                    ...
                    <div className="wink-actions wink-actions-between" style={{ marginTop: 14 }}>
                      <div className="wink-score-pill">
            ...
            <section className="wink-panel" style={{ marginTop: 20 }}>
              ...
              <div className="wink-card-title" style={{ fontSize: 34, marginBottom: 18 }}>
                {formatCurrency(total, lang)}
              </div>

              <div className="wink-actions wink-actions-between">
                <button type="button" className="wink-secondary-btn" onClick={handleClear}>
                  {ui.clear}
                </button>
